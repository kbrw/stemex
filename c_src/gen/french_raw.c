...
extern "C" {
#endif
extern int french_raw_stem(struct SN_env * z);
#ifdef __cplusplus
}
#endif
...
extern struct SN_env * french_raw_create_env(void);
extern void french_raw_close_env(struct SN_env * z);
...
extern struct SN_env * french_raw_create_env(void) { return SN_create_env(0, 3, 0); }

extern void french_raw_close_env(struct SN_env * z) { SN_close_env(z, 0); }
