...
extern "C" {
#endif
extern int french2_stem(struct SN_env * z);
#ifdef __cplusplus
}
#endif
...
extern struct SN_env * french2_create_env(void);
extern void french2_close_env(struct SN_env * z);
...
static const symbol s_38[] = { 0xC3, 0xAB };
static const symbol s_39[] = { 0xC3, 0xA9 };
static const symbol s_40[] = { 0xC3, 0xAA };
static const symbol s_41[] = { 0xC3, 0xA8 };
static const symbol s_42[] = { 'e' };
static const symbol s_43[] = { 0xC3, 0xA2 };
static const symbol s_44[] = { 0xC3, 0xA0 };
static const symbol s_45[] = { 'a' };
static const symbol s_46[] = { 0xC3, 0xBB };
static const symbol s_47[] = { 0xC3, 0xB9 };
static const symbol s_48[] = { 0xC3, 0xBC };
static const symbol s_49[] = { 'u' };
static const symbol s_50[] = { 0xC3, 0xAF };
static const symbol s_51[] = { 0xC3, 0xAE };
static const symbol s_52[] = { 'i' };
static const symbol s_53[] = { 0xC3, 0xB4 };
static const symbol s_54[] = { 'o' };
static const symbol s_55[] = { 0xC3, 0xA7 };
static const symbol s_56[] = { 'c' };
static const symbol s_57[] = { 'Y' };
static const symbol s_58[] = { 'i' };
static const symbol s_59[] = { 0xC3, 0xA7 };
static const symbol s_60[] = { 'c' };

static int r_prelude(struct SN_env * z) {
    while(1) { /* repeat, line 39 */
        int c1 = z->c;
        while(1) { /* goto, line 39 */
            int c2 = z->c;
            {   int c3 = z->c; /* or, line 45 */
                if (in_grouping_U(z, g_v, 97, 251, 0)) goto lab3;
                z->bra = z->c; /* [, line 41 */
                {   int c4 = z->c; /* or, line 41 */
            ...
            lab3:
                ...
                {   int ret = slice_from_s(z, 1, s_7); /* <-, line 46 */
                    if (ret < 0) return ret;
                }
                goto lab2;
            lab7:
                ...
                z->ket = z->c; /* ], line 48 */
                {   int ret = slice_from_s(z, 1, s_10); /* <-, line 48 */
                    if (ret < 0) return ret;
                }
            }
        lab2:
...
static int r_mark_regions(struct SN_env * z) {
    ...
    z->I[1] = z->l;
    z->I[2] = z->l;
    {   int c1 = z->c; /* do, line 57 */
        {   int c2 = z->c; /* or, line 59 */
            if (in_grouping_U(z, g_v, 97, 251, 0)) goto lab2;
            if (in_grouping_U(z, g_v, 97, 251, 0)) goto lab2;
            {   int ret = skip_utf8(z->p, z->c, 0, z->l, 1);
                if (ret < 0) goto lab2;
                z->c = ret; /* next, line 58 */
            }
            goto lab1;
        lab2:
            z->c = c2;
            if (z->c + 2 >= z->l || z->p[z->c + 2] >> 5 != 3 || !((331776 >> (z->p[z->c + 2] & 0x1f)) & 1)) goto lab3;
            if (!(find_among(z, a_0, 3))) goto lab3; /* among, line 60 */
            goto lab1;
        lab3:
            z->c = c2;
            {   int ret = skip_utf8(z->p, z->c, 0, z->l, 1);
                if (ret < 0) goto lab0;
                z->c = ret; /* next, line 67 */
            }
    ...
    lab1:
        z->I[0] = z->c; /* setmark pV, line 68 */
    lab0:
        z->c = c1;
    }
    {   int c3 = z->c; /* do, line 70 */
...
static int r_postlude(struct SN_env * z) {
    int among_var;
    while(1) { /* repeat, line 76 */
        int c1 = z->c;
        z->bra = z->c; /* [, line 78 */
        if (z->c >= z->l || z->p[z->c + 0] >> 5 != 2 || !((35652096 >> (z->p[z->c + 0] & 0x1f)) & 1)) among_var = 4; else
        among_var = find_among(z, a_1, 4); /* substring, line 78 */
        if (!(among_var)) goto lab0;
        z->ket = z->c; /* ], line 78 */
        switch(among_var) {
            case 0: goto lab0;
            case 1:
                {   int ret = slice_from_s(z, 1, s_11); /* <-, line 79 */
                    if (ret < 0) return ret;
                }
                break;
            case 2:
                {   int ret = slice_from_s(z, 1, s_12); /* <-, line 80 */
                    if (ret < 0) return ret;
                }
                break;
            case 3:
                {   int ret = slice_from_s(z, 1, s_13); /* <-, line 81 */
                    if (ret < 0) return ret;
                }
                break;
            case 4:
...
static int r_standard_suffix(struct SN_env * z) {
    int among_var;
    z->ket = z->c; /* [, line 93 */
    among_var = find_among_b(z, a_4, 43); /* substring, line 93 */
    ...
    switch(among_var) {
        ...
        case 2:
            {   int ret = r_R2(z);
                if (ret == 0) return 0; /* call R2, line 100 */
                if (ret < 0) return ret;
            }
            {   int ret = slice_del(z); /* delete, line 100 */
                if (ret < 0) return ret;
            }
            {   int m_keep = z->l - z->c;/* (void) m_keep;*/ /* try, line 101 */
                z->ket = z->c; /* [, line 101 */
                if (!(eq_s_b(z, 2, s_14))) { z->c = z->l - m_keep; goto lab0; }
                z->bra = z->c; /* ], line 101 */
                {   int m1 = z->l - z->c; (void)m1; /* or, line 101 */
                    {   int ret = r_R2(z);
                ...
                lab2:
                    z->c = z->l - m1;
                    {   int ret = slice_from_s(z, 3, s_15); /* <-, line 101 */
                        if (ret < 0) return ret;
                    }
                }
            lab1:
        ...
        case 3:
            ...
            {   int ret = slice_from_s(z, 3, s_16); /* <-, line 105 */
                if (ret < 0) return ret;
            }
            break;
        case 4:
            ...
            {   int ret = slice_from_s(z, 1, s_17); /* <-, line 108 */
                if (ret < 0) return ret;
            }
            break;
        case 5:
            ...
            {   int ret = slice_from_s(z, 3, s_18); /* <-, line 111 */
                if (ret < 0) return ret;
            }
            break;
        case 6:
            {   int ret = r_RV(z);
                if (ret == 0) return 0; /* call RV, line 115 */
                if (ret < 0) return ret;
            }
            {   int ret = slice_del(z); /* delete, line 115 */
                if (ret < 0) return ret;
            }
            {   int m_keep = z->l - z->c;/* (void) m_keep;*/ /* try, line 116 */
                z->ket = z->c; /* [, line 117 */
                among_var = find_among_b(z, a_2, 6); /* substring, line 117 */
                ...
                switch(among_var) {
                    ...
                    case 1:
                        {   int ret = r_R2(z);
                            if (ret == 0) { z->c = z->l - m_keep; goto lab3; } /* call R2, line 118 */
                            if (ret < 0) return ret;
                        }
                        ...
                        break;
                    case 2:
                        {   int m2 = z->l - z->c; (void)m2; /* or, line 119 */
                            {   int ret = r_R2(z);
                                if (ret == 0) goto lab5; /* call R2, line 119 */
                                if (ret < 0) return ret;
                            }
                        ...
                        lab5:
                            z->c = z->l - m2;
                            {   int ret = r_R1(z);
                                if (ret == 0) { z->c = z->l - m_keep; goto lab3; } /* call R1, line 119 */
                                if (ret < 0) return ret;
                            }
                            {   int ret = slice_from_s(z, 3, s_20); /* <-, line 119 */
                                if (ret < 0) return ret;
                            }
                        }
                    lab4:
                    ...
                    case 3:
                        {   int ret = r_R2(z);
                            if (ret == 0) { z->c = z->l - m_keep; goto lab3; } /* call R2, line 121 */
                            if (ret < 0) return ret;
                        }
                    ...
                    case 4:
                        {   int ret = r_RV(z);
                            if (ret == 0) { z->c = z->l - m_keep; goto lab3; } /* call RV, line 123 */
                            if (ret < 0) return ret;
                        }
                        {   int ret = slice_from_s(z, 1, s_21); /* <-, line 123 */
                            if (ret < 0) return ret;
                        }
                        break;
                }
        ...
        case 7:
            ...
            {   int m_keep = z->l - z->c;/* (void) m_keep;*/ /* try, line 131 */
                z->ket = z->c; /* [, line 132 */
                if (z->c - 1 <= z->lb || z->p[z->c - 1] >> 5 != 3 || !((4198408 >> (z->p[z->c - 1] & 0x1f)) & 1)) { z->c = z->l - m_keep; goto lab6; }
                among_var = find_among_b(z, a_3, 3); /* substring, line 132 */
                if (!(among_var)) { z->c = z->l - m_keep; goto lab6; }
                z->bra = z->c; /* ], line 132 */
                switch(among_var) {
                    case 0: { z->c = z->l - m_keep; goto lab6; }
                    case 1:
                        {   int m3 = z->l - z->c; (void)m3; /* or, line 133 */
                            {   int ret = r_R2(z);
                                if (ret == 0) goto lab8; /* call R2, line 133 */
                                if (ret < 0) return ret;
                            }
                        ...
                        lab8:
                            z->c = z->l - m3;
                            {   int ret = slice_from_s(z, 3, s_22); /* <-, line 133 */
                                if (ret < 0) return ret;
                            }
                        }
                    lab7:
                        break;
                    case 2:
                        {   int m4 = z->l - z->c; (void)m4; /* or, line 134 */
                            {   int ret = r_R2(z);
                                if (ret == 0) goto lab10; /* call R2, line 134 */
                                if (ret < 0) return ret;
                            }
                        ...
                        lab10:
                            z->c = z->l - m4;
                            {   int ret = slice_from_s(z, 3, s_23); /* <-, line 134 */
                                if (ret < 0) return ret;
                            }
                        }
                    lab9:
                    ...
                    case 3:
                        {   int ret = r_R2(z);
                            if (ret == 0) { z->c = z->l - m_keep; goto lab6; } /* call R2, line 135 */
                            if (ret < 0) return ret;
                        }
        ...
        case 8:
            ...
            {   int m_keep = z->l - z->c;/* (void) m_keep;*/ /* try, line 143 */
                ...
                z->bra = z->c; /* ], line 143 */
                {   int ret = r_R2(z);
                    if (ret == 0) { z->c = z->l - m_keep; goto lab11; } /* call R2, line 143 */
                    if (ret < 0) return ret;
                }
                ...
                z->bra = z->c; /* ], line 143 */
                {   int m5 = z->l - z->c; (void)m5; /* or, line 143 */
                    {   int ret = r_R2(z);
                        if (ret == 0) goto lab13; /* call R2, line 143 */
                        if (ret < 0) return ret;
                    }
                    {   int ret = slice_del(z); /* delete, line 143 */
                        if (ret < 0) return ret;
                ...
                lab13:
                    z->c = z->l - m5;
                    {   int ret = slice_from_s(z, 3, s_26); /* <-, line 143 */
                        if (ret < 0) return ret;
                    }
                }
            lab12:
            ...
            break;
        case 9:
            {   int ret = slice_from_s(z, 3, s_27); /* <-, line 145 */
                if (ret < 0) return ret;
            }
            break;
        case 10:
            {   int ret = r_R1(z);
                if (ret == 0) return 0; /* call R1, line 146 */
                if (ret < 0) return ret;
            }
            {   int ret = slice_from_s(z, 2, s_28); /* <-, line 146 */
                if (ret < 0) return ret;
            }
            break;
        case 11:
            {   int m6 = z->l - z->c; (void)m6; /* or, line 148 */
                {   int ret = r_R2(z);
                    if (ret == 0) goto lab15; /* call R2, line 148 */
                    if (ret < 0) return ret;
                }
            ...
            lab15:
                z->c = z->l - m6;
                {   int ret = r_R1(z);
                    if (ret == 0) return 0; /* call R1, line 148 */
                    if (ret < 0) return ret;
                }
                {   int ret = slice_from_s(z, 3, s_29); /* <-, line 148 */
                    if (ret < 0) return ret;
                }
            }
        lab14:
        ...
        case 13:
            ...
            {   int ret = slice_from_s(z, 3, s_30); /* <-, line 156 */
                if (ret < 0) return ret;
            }
        ...
        case 14:
            {   int ret = r_RV(z);
                if (ret == 0) return 0; /* call RV, line 157 */
                if (ret < 0) return ret;
            }
            {   int ret = slice_from_s(z, 3, s_31); /* <-, line 157 */
                if (ret < 0) return ret;
            }
            return 0; /* fail, line 157 */
            break;
        case 15:
            {   int m_test = z->l - z->c; /* test, line 159 */
                if (in_grouping_b_U(z, g_v, 97, 251, 0)) return 0;
                {   int ret = r_RV(z);
                    if (ret == 0) return 0; /* call RV, line 159 */
                    if (ret < 0) return ret;
                }
                z->c = z->l - m_test;
            }
...
static int r_i_verb_suffix(struct SN_env * z) {
    ...
    {   int mlimit; /* setlimit, line 164 */
        ...
        among_var = find_among_b(z, a_5, 35); /* substring, line 165 */
...
static int r_verb_suffix(struct SN_env * z) {
    int among_var;
    {   int mlimit; /* setlimit, line 175 */
        int m1 = z->l - z->c; (void)m1;
        if (z->c < z->I[0]) return 0;
        z->c = z->I[0]; /* tomark, line 175 */
        mlimit = z->lb; z->lb = z->c;
        z->c = z->l - m1;
        z->ket = z->c; /* [, line 176 */
        among_var = find_among_b(z, a_6, 38); /* substring, line 176 */
        if (!(among_var)) { z->lb = mlimit; return 0; }
        z->bra = z->c; /* ], line 176 */
        switch(among_var) {
            case 0: { z->lb = mlimit; return 0; }
            case 1:
                {   int ret = r_R2(z);
                    if (ret == 0) { z->lb = mlimit; return 0; } /* call R2, line 178 */
                    if (ret < 0) return ret;
                }
            ...
            case 3:
                ...
                {   int m_keep = z->l - z->c;/* (void) m_keep;*/ /* try, line 192 */
                    z->ket = z->c; /* [, line 192 */
...
static int r_residual_suffix(struct SN_env * z) {
    int among_var;
    {   int m_keep = z->l - z->c;/* (void) m_keep;*/ /* try, line 200 */
        z->ket = z->c; /* [, line 200 */
        if (!(eq_s_b(z, 1, s_33))) { z->c = z->l - m_keep; goto lab0; }
        z->bra = z->c; /* ], line 200 */
        {   int m_test = z->l - z->c; /* test, line 200 */
    ...
    {   int mlimit; /* setlimit, line 201 */
        int m1 = z->l - z->c; (void)m1;
        if (z->c < z->I[0]) return 0;
        z->c = z->I[0]; /* tomark, line 201 */
        mlimit = z->lb; z->lb = z->c;
        z->c = z->l - m1;
        z->ket = z->c; /* [, line 202 */
        among_var = find_among_b(z, a_7, 7); /* substring, line 202 */
        if (!(among_var)) { z->lb = mlimit; return 0; }
        z->bra = z->c; /* ], line 202 */
        switch(among_var) {
            case 0: { z->lb = mlimit; return 0; }
            case 1:
                {   int ret = r_R2(z);
                    if (ret == 0) { z->lb = mlimit; return 0; } /* call R2, line 203 */
                    if (ret < 0) return ret;
                }
                {   int m2 = z->l - z->c; (void)m2; /* or, line 203 */
            ...
            lab1:
                ...
                break;
            case 2:
                {   int ret = slice_from_s(z, 1, s_36); /* <-, line 205 */
                    if (ret < 0) return ret;
                }
                break;
            case 3:
...
static int r_un_double(struct SN_env * z) {
    {   int m_test = z->l - z->c; /* test, line 213 */
        if (z->c - 2 <= z->lb || z->p[z->c - 1] >> 5 != 3 || !((1069056 >> (z->p[z->c - 1] & 0x1f)) & 1)) return 0;
        if (!(find_among_b(z, a_8, 5))) return 0; /* among, line 213 */
        z->c = z->l - m_test;
    }
    z->ket = z->c; /* [, line 213 */
    {   int ret = skip_utf8(z->p, z->c, z->lb, 0, -1);
        if (ret < 0) return 0;
        z->c = ret; /* next, line 213 */
    }
    z->bra = z->c; /* ], line 213 */
...
static int r_un_accent(struct SN_env * z) {
    while(1) { /* repeat, line 216 */
        int m1 = z->l - z->c; (void)m1;
        while(1) { /* gopast, line 216 */
            int m2 = z->l - z->c; (void)m2;
            {   int m3 = z->l - z->c; (void)m3; /* or, line 218 */
                z->ket = z->c; /* [, line 217 */
                {   int m4 = z->l - z->c; (void)m4; /* or, line 217 */
                    if (!(eq_s_b(z, 2, s_38))) goto lab5;
                    goto lab4;
                lab5:
                    z->c = z->l - m4;
                    if (!(eq_s_b(z, 2, s_39))) goto lab6;
                    goto lab4;
                lab6:
                    z->c = z->l - m4;
                    if (!(eq_s_b(z, 2, s_40))) goto lab7;
                    goto lab4;
                lab7:
                    z->c = z->l - m4;
                    if (!(eq_s_b(z, 2, s_41))) goto lab3;
                }
            lab4:
                z->bra = z->c; /* ], line 217 */
                {   int ret = slice_from_s(z, 1, s_42); /* <-, line 217 */
                    if (ret < 0) return ret;
                }
                goto lab2;
            lab3:
                z->c = z->l - m3;
                z->ket = z->c; /* [, line 219 */
                {   int m5 = z->l - z->c; (void)m5; /* or, line 219 */
                    if (!(eq_s_b(z, 2, s_43))) goto lab10;
                    goto lab9;
                lab10:
                    z->c = z->l - m5;
                    if (!(eq_s_b(z, 2, s_44))) goto lab8;
                }
            lab9:
                z->bra = z->c; /* ], line 219 */
                {   int ret = slice_from_s(z, 1, s_45); /* <-, line 219 */
                    if (ret < 0) return ret;
                }
                goto lab2;
            lab8:
                z->c = z->l - m3;
                z->ket = z->c; /* [, line 221 */
                {   int m6 = z->l - z->c; (void)m6; /* or, line 221 */
                    if (!(eq_s_b(z, 2, s_46))) goto lab13;
                    goto lab12;
                lab13:
                    z->c = z->l - m6;
                    if (!(eq_s_b(z, 2, s_47))) goto lab14;
                    goto lab12;
                lab14:
                    z->c = z->l - m6;
                    if (!(eq_s_b(z, 2, s_48))) goto lab11;
                }
            lab12:
                z->bra = z->c; /* ], line 221 */
                {   int ret = slice_from_s(z, 1, s_49); /* <-, line 221 */
                    if (ret < 0) return ret;
                }
                goto lab2;
            lab11:
                z->c = z->l - m3;
                z->ket = z->c; /* [, line 223 */
                {   int m7 = z->l - z->c; (void)m7; /* or, line 223 */
                    if (!(eq_s_b(z, 2, s_50))) goto lab17;
                    goto lab16;
                lab17:
                    z->c = z->l - m7;
                    if (!(eq_s_b(z, 2, s_51))) goto lab15;
                }
            lab16:
                z->bra = z->c; /* ], line 223 */
                {   int ret = slice_from_s(z, 1, s_52); /* <-, line 223 */
                    if (ret < 0) return ret;
                }
                goto lab2;
            lab15:
                z->c = z->l - m3;
                z->ket = z->c; /* [, line 225 */
                if (!(eq_s_b(z, 2, s_53))) goto lab18;
                z->bra = z->c; /* ], line 225 */
                {   int ret = slice_from_s(z, 1, s_54); /* <-, line 225 */
                    if (ret < 0) return ret;
                }
                goto lab2;
            lab18:
                z->c = z->l - m3;
                z->ket = z->c; /* [, line 227 */
                if (!(eq_s_b(z, 2, s_55))) goto lab1;
                z->bra = z->c; /* ], line 227 */
                {   int ret = slice_from_s(z, 1, s_56); /* <-, line 227 */
                    if (ret < 0) return ret;
                }
            }
        lab2:
...
extern int french2_stem(struct SN_env * z) {
    {   int c1 = z->c; /* do, line 233 */
        {   int ret = r_prelude(z);
            if (ret == 0) goto lab0; /* call prelude, line 233 */
            if (ret < 0) return ret;
        }
    lab0:
        z->c = c1;
    }
    {   int c2 = z->c; /* do, line 234 */
        {   int ret = r_mark_regions(z);
            if (ret == 0) goto lab1; /* call mark_regions, line 234 */
            if (ret < 0) return ret;
        }
    lab1:
        z->c = c2;
    ...
    {   int m3 = z->l - z->c; (void)m3; /* do, line 237 */
        {   int m4 = z->l - z->c; (void)m4; /* or, line 247 */
            {   int m5 = z->l - z->c; (void)m5; /* and, line 243 */
                {   int m6 = z->l - z->c; (void)m6; /* or, line 239 */
                    {   int ret = r_standard_suffix(z);
                        if (ret == 0) goto lab6; /* call standard_suffix, line 239 */
                        if (ret < 0) return ret;
                    }
                    goto lab5;
                lab6:
                    ...
                    {   int ret = r_i_verb_suffix(z);
                        if (ret == 0) goto lab7; /* call i_verb_suffix, line 240 */
                        if (ret < 0) return ret;
                    }
                    goto lab5;
                lab7:
                    ...
                    {   int ret = r_verb_suffix(z);
                        if (ret == 0) goto lab4; /* call verb_suffix, line 241 */
                        if (ret < 0) return ret;
                    }
                }
            lab5:
                z->c = z->l - m5;
                {   int m_keep = z->l - z->c;/* (void) m_keep;*/ /* try, line 244 */
                    z->ket = z->c; /* [, line 244 */
                    {   int m7 = z->l - z->c; (void)m7; /* or, line 244 */
                        if (!(eq_s_b(z, 1, s_57))) goto lab10;
                        z->bra = z->c; /* ], line 244 */
                        {   int ret = slice_from_s(z, 1, s_58); /* <-, line 244 */
                            if (ret < 0) return ret;
                        }
                        goto lab9;
                    lab10:
                        z->c = z->l - m7;
                        if (!(eq_s_b(z, 2, s_59))) { z->c = z->l - m_keep; goto lab8; }
                        z->bra = z->c; /* ], line 245 */
                        {   int ret = slice_from_s(z, 1, s_60); /* <-, line 245 */
                            if (ret < 0) return ret;
                        }
                    }
                lab9:
        ...
        lab4:
            ...
            {   int ret = r_residual_suffix(z);
                if (ret == 0) goto lab2; /* call residual_suffix, line 248 */
                if (ret < 0) return ret;
            }
        }
    lab3:
    ...
    {   int m8 = z->l - z->c; (void)m8; /* do, line 253 */
        {   int ret = r_un_double(z);
            if (ret == 0) goto lab11; /* call un_double, line 253 */
            if (ret < 0) return ret;
        }
    lab11:
        z->c = z->l - m8;
    }
    {   int m9 = z->l - z->c; (void)m9; /* do, line 254 */
        {   int ret = r_un_accent(z);
            if (ret == 0) goto lab12; /* call un_accent, line 254 */
            if (ret < 0) return ret;
        }
    lab12:
        z->c = z->l - m9;
    ...
    z->c = z->lb;
    {   int c10 = z->c; /* do, line 256 */
        {   int ret = r_postlude(z);
            if (ret == 0) goto lab13; /* call postlude, line 256 */
            if (ret < 0) return ret;
        }
    lab13:
        z->c = c10;
...
extern struct SN_env * french2_create_env(void) { return SN_create_env(0, 3, 0); }

extern void french2_close_env(struct SN_env * z) { SN_close_env(z, 0); }
